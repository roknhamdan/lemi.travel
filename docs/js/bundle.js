...
void 0 === jQuery.migrateMute && (jQuery.migrateMute = !0), function (e) {
  ...
  e.migrateVersion = "3.0.1", function () {
    var r = /^[12]\./;
    t.console && t.console.log && (e && !r.test(e.fn.jquery) || t.console.log("JQMIGRATE: jQuery 3.0.0+ REQUIRED"), e.migrateWarnings && t.console.log("JQMIGRATE: Migrate plugin loaded multiple times"));
  }();
  var o = {};
...
}(window.Zepto || window.jQuery, window, document); // Fullscreen Detection
...
})(); // Custom Resize Event Listener - https://developer.mozilla.org/en-US/docs/Web/Events/resize
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (jQuery().matchHeight) {
    ...
    window.addEventListener('optimizedResize', function () {
      setTimeout(function () {
        ...
        $.fn.matchHeight._update(); // 300ms timeout to allow for document re-flows etc.
  ...
  $('a[href^="#"]').click(function (event) {
    ...
    moveTo.move(target); // Emulate default event.
  ...
  (function () {
    var checkNavbar = function () {
      var breakpoint = $("body").css("--breakpoint-md").replace("px", "");
      window.innerWidth <= breakpoint ? $(".navbar").removeClass("fixed-top") : $(".navbar").addClass("fixed-top");
    }; // Once on load


    checkNavbar(); // Allow the navigation to be scrolled if the breakpoint is hit.
      ...
      $.when(ajaxLists).done(function () {
        ...
        $.each(lists, function (i) {
          var country = lists[i].country,
              ...
              place = lists[i].place,
              content = lists[i].content; // Create the template

          var template = "<div class=\"col-lg-4\">\n    <img src=\"img/".concat(imgUrl, "\" class=\"img-fluid\" alt=\"\" />\n    <span class=\"mt-4 text-muted small font-weight-bold\">").concat(country, "</span>\n    <h3 class=\"font-weight-bold\">").concat(place, "</h3>\n    <p>").concat(content, "</p>\n    <div class=\"d-flex justify-content-center\">\n        <a href=\"#\" class=\"btn btn-primary pb-2 px-4 mb-4\">View List</a>\n    </div>\n</div>\n"); // Append it to the HTML
  ...
  (function () {
    ...
    var photosSrc = ["https://scontent.cdninstagram.com/vp/039df4d882b57d040bdea299e515c628/5CCC9941/t51.2885-15/sh0.08/e35/s640x640/49491333_138348780507247_2442670192313937944_n.jpg?_nc_ht=scontent.cdninstagram.com", "https://scontent.cdninstagram.com/vp/7155de36c51e07c3d281a9b9a3d6ed86/5CBFED42/t51.2885-15/sh0.08/e35/s640x640/47694889_354498131770471_6499041732427944214_n.jpg?_nc_ht=scontent.cdninstagram.com", "https://scontent.cdninstagram.com/vp/b88a3f9986d6dee1904d22a063ad682b/5CFBB7E1/t51.2885-15/sh0.08/e35/s640x640/50050168_288718498665742_1621002317225338959_n.jpg?_nc_ht=scontent.cdninstagram.com", "https://scontent.cdninstagram.com/vp/13b56f8449a90ac90504eb26ffda8ea9/5CBD5E66/t51.2885-15/sh0.08/e35/s640x640/50030099_2215153008753886_6195491990221852619_n.jpg?_nc_ht=scontent.cdninstagram.com", "https://scontent.cdninstagram.com/vp/a02dd9416965f7f5de9cc063881a6da9/5CBF37DF/t51.2885-15/sh0.08/e35/s640x640/49573754_2215704865370833_4377890919128860830_n.jpg?_nc_ht=scontent.cdninstagram.com", "https://scontent.cdninstagram.com/vp/517072bac809ee4b01178ab031262d00/5CDE3FD2/t51.2885-15/sh0.08/e35/p640x640/49513812_245339746362947_3051696781557949818_n.jpg?_nc_ht=scontent.cdninstagram.com", "https://scontent.cdninstagram.com/vp/6827999ff8aaed46cfd825356584c91a/5CC867A0/t51.2885-15/sh0.08/e35/s640x640/47691703_138215260533524_8854908795802094457_n.jpg?_nc_ht=scontent.cdninstagram.com", "https://scontent.cdninstagram.com/vp/b8d10eb1e205b20a113be258e54c3a5a/5CCBA09D/t51.2885-15/sh0.08/e35/p640x640/47693652_314930105808092_4862334254119211800_n.jpg?_nc_ht=scontent.cdninstagram.com"]; // Render them into the HTML.

    for (var i = 0; i < photosSrc.length; i++) {
      var template = "<div class=\"card js-instagram-clickable border-0\">\n    <img data-indexId=\"".concat(i, "\" class=\"img-fluid\" src=\"").concat(photosSrc[i], "\" />\n</div>\n");
      $(".card-columns").append(template); // Fill the carousel

      var carouselContent = "<img src=\"".concat(photosSrc[i], "\" alt=\"\">");
    ...
    instagramCarousel.owlCarousel({
      ...
      onInitialized: function (e) {
        $("#js-total-image").text(e.item.count); // $(`#js-current-image`).text(e.item.index);
      },
      // Check the current image index and display it.
      onChanged: function (e) {
        $("#js-current-image").text(e.item.index + 1); // Make sure the height of the modal updates.
    ...
    $(".js-carousel-controls").click(function (e) {
    ...
    $(".js-instagram-clickable").click(function () {
      ...
      var clickedImg = $(this).find("img").attr("data-indexid");
  ...
  $("a[href='#']").attr('href', 'javascript:void(0)'); // $('a').attr('href', 'javascript:void(0)');
  ...
  if ($('input').length > 1) {
    ...
    inputFieldsArray = inputFieldsArray.join(' = '); // Add the end of the variable decleration
...
document.addEventListener('scroll', function () {}); // On Resizing
